...
public record FlashCard
{
    ...
    [Required] [Column("question")] public string? Question { get; init; }
    [Required] [Column("answer")] public string? Answer { get; init; }
    [Required] [Column("deck_id")] public int DeckId { get; init; }
}
...
public record DeckMark
{
    ...
    [Required] [Column("deck_id")] public int DeckId { get; init; }
    [Required] [Column("account_id")] public int AccountId { get; init; }
}